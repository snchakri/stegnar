...
tic
dirSource = '/data1/dataset/wuwl/jpeg/cover_qf75_256';                 % input dir for all QFs
output_dir = '/data1/dataset/wuwl/jpeg/uerd20';                        % output dir of all schemes
%output_dir = '/data1/dataset/wuwl/jpeg/uerd40';                        % output dir of all schemes
rand('state',SEED);
...
for xxx = 1:length(CAPA)
    ...
    dirSource_qf = dirSource;                             % input dir for each QF
    Output_path = [output_dir '/' num2str(CAPACITY)];     % output dir of each scheme
