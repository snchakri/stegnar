          ...
          <div className="rounded-lg border" style={{ background: 'var(--bg-card)', borderColor: 'var(--border-default)' }}>
            ...
            <div className="p-4 space-y-3">
              {[
                ...
                { key: 'enableNotifications', label: 'Browser notifications',       description: 'Show system notifications in browser on STEGO detection' },
                { key: 'enableEmailAlerts',   label: 'Email alerts',                description: 'Send email notifications for critical STEGO events' },
